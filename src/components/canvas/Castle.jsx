...
export const Castle = (props) => {
  ...
  return (
    <>
      ...
      <primitive ref={castleRef} object={scene} {...props} onPointerOver={(e) => handleHover(e)} onPointerOut={handleNonHover} onClick={(e) => { zoomToView(e) }} onPointerMissed={() => setZoom(false)} />
      <mesh ref={ghostMesh} />
    </>
  )
}